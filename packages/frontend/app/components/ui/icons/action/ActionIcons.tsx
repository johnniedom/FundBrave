...
/**
 * Heart Icon
 * Used for like/favorite actions
...
/**
 * Bookmark Icon
 * Used for save/bookmark actions
 * Source: Lucide Icons (MIT License)
 */
...
/**
 * Share Icon
 * Used for share actions (arrow pointing up from box)
 * Source: Lucide Icons (MIT License)
 */
...
/**
 * Share2 Icon
 * Alternative share icon (connected nodes)
 * Source: Lucide Icons (MIT License)
 */
export const Share2 = forwardRef<SVGSVGElement, IconProps>(
  ({ size = 24, className, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
/**
 * Repeat2 Icon
 * Used for repost/retweet actions
 * Source: Lucide Icons (MIT License)
 */
export const Repeat2 = forwardRef<SVGSVGElement, IconProps>(
  ({ size = 24, className, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
/**
 * BarChart3 Icon
 * Used for views/analytics display
 * Source: Lucide Icons (MIT License)
 */
